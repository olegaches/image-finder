...
import com.olegaches.imagefinder.presentation.root.RootComponentImpl
import com.olegaches.imagefinder.presentation.root.RootScreen
...
class RootComponentCreator(
    private val rootComponentFactory: (ComponentContext) -> RootComponentImpl,
) {
    fun create(componentContext: ComponentContext): RootComponentImpl {
