package com.olegaches.imagefinder.ui.theme
    ...
    MaterialTheme(
        ...
        typography = Typography.apply {
            copy(
                ...
                titleSmall = titleSmall.copy(platformStyle = PlatformTextStyle()),
                bodyLarge = bodyLarge.copy(platformStyle = PlatformTextStyle()),
                bodyMedium = bodyMedium.copy(platformStyle = PlatformTextStyle()),
                bodySmall = bodySmall.copy(platformStyle = PlatformTextStyle()),
                labelLarge = labelLarge.copy(platformStyle = PlatformTextStyle()),
                labelMedium = labelMedium.copy(platformStyle = PlatformTextStyle()),
                labelSmall = labelSmall.copy(platformStyle = PlatformTextStyle()),
            )
        },
        content = content
    )
